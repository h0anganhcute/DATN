...
public class TargetBoss1 : MonoBehaviour
{
    Animator ani;
    ...
    void Update()
    {
        ...
        {
            // Kích hoạt animation chạy (cần chắc chắn trong Animator có trigger tên "Run")
            ani.SetTrigger("Run");

            // Ra lệnh cho bộ não AI liên tục đi đến vị trí hiện tại của mục tiêu.
