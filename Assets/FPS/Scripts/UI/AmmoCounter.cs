...
namespace Unity.FPS.UI
{
    ...
    public class AmmoCounter : MonoBehaviour
    {
        ...
        public void Initialize(WeaponController weapon, int weaponIndex)
        {
            ...
            // ĐÃ CHỈNH SỬA: Không gọi WeaponIcon và ẩn hẳn Object hiển thị Icon đi
            if (WeaponImage != null)
            {
                // WeaponImage.sprite = weapon.WeaponIcon; // Đã khóa dòng này
                WeaponImage.gameObject.SetActive(false);   // Ẩn hẳn Object UI này đi
            }
